<?php include '../partials/header.php'; ?>
        ...
        <!-- Header Data Table -->
        <div class="container">
          <h3 class="mt-3 text-body-secondary">Data Rest Area Travoy
          <a href="restarea-add.php">
          ...
          <div class="card mt-3 mb-5 shadow">
            <div class="card-body" style="overflow-x: auto;">
              ...
              <form class="d-flex mb-3" role="search" action="restarea-table.php" method="get">
                    ...
                    <input class="form-control border-1 border-secondary ms-5" type="text" name="search" placeholder="Search Here" style="width: 30%">
                    ...
                    <tr>
                      ...
                      <td>
                          <div class="justify-center d-flex text-center gap-2">
                            ...
                            <a href="restarea-edit.php?id=<?php echo $data['id']; ?>">
                            <button type="button" class="btn btn-warning" name=""> <i class="fa fa-pencil"></i></button></a>
                          
                            <a onclick="return confirm('Ingin Menghapus Data ?')" href="../models/data-restarea/delete.php?id=<?php echo $data['id']; ?>">
